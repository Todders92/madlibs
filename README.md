...
#### _A Page For Making Silly Stories, January 2020_

#### By _**Todd Walraven**_

## Description

_This application has the user fill out a form for nouns, adjectives, verbs, etc. It then appends these to a premade story for comedic effect_
